...
<# Begin: DataSource "AD-user-generate-table-attributes-basic-update-employeeID" #>
$tmpPsScript = @'
try {
...
AD-user-generate-table-attributes-basic-update-employeeID
'@ 
Invoke-HelloIDDatasource -DatasourceName $dataSourceGuid_1_Name -DatasourceType "4" -DatasourceInput $tmpInput -DatasourcePsScript $tmpPsScript -DatasourceModel $tmpModel -returnObject ([Ref]$dataSourceGuid_1) 
<# End: DataSource "AD-user-generate-table-attributes-basic-update-employeeID" #>

<# Begin: DataSource "AD-user-generate-table-wildcard-update-employeeid" #>
$tmpPsScript = @'
try {
...
AD-user-generate-table-wildcard-update-employeeid
'@ 
Invoke-HelloIDDatasource -DatasourceName $dataSourceGuid_0_Name -DatasourceType "4" -DatasourceInput $tmpInput -DatasourcePsScript $tmpPsScript -DatasourceModel $tmpModel -returnObject ([Ref]$dataSourceGuid_0) 
<# End: DataSource "AD-user-generate-table-wildcard-update-employeeid" #>
